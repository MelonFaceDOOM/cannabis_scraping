...
with open(r'ganjagrams_scraped.txt', 'r') as f:
...
for product in products:
    ...
    if prices:
        for price in prices:
            products_flattened.append([product['url'], product['name'], product['categories'], 
                                       price[0], price[1]])
    else:
        products_flattened.append([product['url'], product['name'], product['categories'], 
                                       ""])
                                   
with open("ganjagrams_inventory.csv", "w") as f:
